---
name: recency-first-tactical-enhanced-v2
version: "1.0"
strategy: recency
...
## Goal
Surface the 3 most recently published videos about AI and entrepreneurship that are relevant to tactical founders. Good for catching actionable insights and strategies for entrepreneurs.
...
Prioritize videos that have transcripts available. If two videos are equally relevant, the one with a transcript should be preferred.
...
- Highlights how it is actionable for entrepreneurs
